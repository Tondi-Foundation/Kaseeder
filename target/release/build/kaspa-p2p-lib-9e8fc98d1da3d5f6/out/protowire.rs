...
pub mod p2p_server {
    ...
    pub trait P2p: std::marker::Send + std::marker::Sync + 'static {
        ...
        type MessageStreamStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::KaspadMessage, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        async fn message_stream(
            &self,
            request: tonic::Request<tonic::Streaming<super::KaspadMessage>>,
        ) -> std::result::Result<
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/protowire.P2P/MessageStream" => {
                    ...
                    impl<T: P2p> tonic::server::StreamingService<super::KaspadMessage>
                    for MessageStreamSvc<T> {
                        type Response = super::KaspadMessage;
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                tonic::Streaming<super::KaspadMessage>,
                            >,
                        ) -> Self::Future {
    ...
    pub const SERVICE_NAME: &str = "protowire.P2P";
